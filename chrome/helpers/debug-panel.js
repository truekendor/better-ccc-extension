...
class DebugPanel {
    ...
    static crCollapseDebugPanelBtn() {
        ...
        btn.addEventListener("click", () => {
            const panel = document.querySelector(".ccc-dev-panel-wrapper");
            if (!panel) {
                return;
            }
    ...
    static crDebugPanel() {
        ...
        this.debugPanel.append(this.panelButtons.crResetBtn(), this.panelButtons.crClearMovesTableBtn(), this.panelButtons.crLoadPGNBtn(), this.panelButtons.crNextMoveBtn(), this.panelButtons.crBookMovesBtn(), this.panelButtons.crCalcTranspositionsBtn(), this.panelButtons.crConsoleLogBtn(), this.crPageLogsBtn());
    ...
    static crPageLogsBtn() {
        ...
        btn.addEventListener("click", () => {
            ...
            if (!this.logsHistoryContainer.classList.contains("ccc-hide")) {
                const cacheHistory = this.logsHistoryContainer.querySelector("._chess_cache_history");
                if (cacheHistory) {
    ...
    static showChessCacheInHistoryLogs() {
        const div = document.createElement("div");
    ...
    static oldButtons() {
        class Buttons {
            ...
            static crClearMovesTableBtn() {
                const btn = document.createElement("button");
                btn.textContent = "delete moves";
                btn.addEventListener("click", (e) => {
                    e.stopPropagation();
                    const gameResult = _DOM_Store.movesTableContainer.querySelector(".movetable-gameResult");
                    if (gameResult) {
            ...
            static crCalcTranspositionsBtn() {
                const btn = document.createElement("button");
        ...
        Buttons.moveIndex = 0;
        Buttons.bookPlyLength = 16;
        // prettier-ignore
        Buttons.pgnCurrent = ["e4", "Nf6", "Nc3", "d5", "exd5", "Nxd5", "Bc4", "Nb6", "Bb3", "Nc6", "Nf3", "Na5", "d4", "Nxb3", "axb3", "g6", "O-O", "Bg7", "Re1", "O-O", "h3", "Bf5", "Bf4", "c6", "Ne2", "Be4", "Nd2", "Bf5", "c4", "Re8", "Nf3", "Be4", "Ne5", "Nd7", "Ng4", "e5", "dxe5", "Bf5", "Nh6+", "Bxh6", "Bxh6", "Nxe5", "Ng3", "Qxd1", "Rexd1", "Bc2",
        ];
        // prettier-ignore
        Buttons.pgnReverse = [
...
_a = DebugPanel;
DebugPanel.debugPanel = document.createElement("div");
DebugPanel.pingElement = document.createElement("div");
DebugPanel.panelButtons = _a.oldButtons();
DebugPanel.timerId = 0;
DebugPanel.logsHistoryMainContent = document.createElement("main");
DebugPanel.logsHistoryContainer = _a.crLogsHistoryContainer();
