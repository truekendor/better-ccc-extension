...
(function (SVG) {
    ...
    class ChessPieces extends SVGBase {
        ...
        static getStrokeColor(color) {
            const strokeColor = color === "white" ? "black" : "#CBCACA";
            return strokeColor;
        }
    }
    SVG.ChessPieces = ChessPieces;
