...
namespace components {
  ...
  export class CrossTable {
    ...
    static crPTNMLStatElement(ptnml: PTNML): HTMLDivElement {
      const ptnmlWrapper = this.crH2HCellStatWrapperElement();
    ...
    static crWDLEloStatElement(wdlArray: WDL): HTMLDivElement {
      const wdlWrapper = this.crH2HCellStatWrapperElement();
     ...
     */
    private static crH2HCellStatWrapperElement(): HTMLDivElement {
      const wrapper = document.createElement("div");
